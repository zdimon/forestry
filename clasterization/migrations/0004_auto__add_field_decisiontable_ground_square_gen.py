...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DecisionTable.ground_square_gen'
        db.add_column(u'clasterization_decisiontable', 'ground_square_gen',
                      self.gf('django.db.models.fields.CharField')(default='zero', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DecisionTable.ground_square_gen'
        db.delete_column(u'clasterization_decisiontable', 'ground_square_gen')
