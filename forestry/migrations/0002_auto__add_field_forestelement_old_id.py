...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ForestElement.old_id'
        db.add_column(u'forestry_forestelement', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ForestElement.old_id'
        db.delete_column(u'forestry_forestelement', 'old_id')
