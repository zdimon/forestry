...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ValueParamPolygon.value'
        db.alter_column(u'forestry_valueparampolygon', 'value', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'TypeParamPolygon.value'
        db.alter_column(u'forestry_typeparampolygon', 'value', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'ValueParamPolygon.value'
        db.alter_column(u'forestry_valueparampolygon', 'value', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'TypeParamPolygon.value'
        db.alter_column(u'forestry_typeparampolygon', 'value', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
