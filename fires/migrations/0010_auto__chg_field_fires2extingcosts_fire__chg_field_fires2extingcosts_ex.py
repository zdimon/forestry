...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Fires2ExtingCosts.fire'
        db.alter_column(u'fires_fires2extingcosts', 'fire_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fires.Fires'], null=True))

        # Changing field 'Fires2ExtingCosts.exting_costs'
        db.alter_column(u'fires_fires2extingcosts', 'exting_costs_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fires.ExtingCosts'], null=True))

        # Changing field 'Fires2ExtingCosts.sum'
        db.alter_column(u'fires_fires2extingcosts', 'sum', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
        # Adding field 'Fires2FireDamage.old_id'
        db.add_column(u'fires_fires2firedamage', 'old_id',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Fires2ExtingCosts.fire'
        db.alter_column(u'fires_fires2extingcosts', 'fire_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fires.Fires']))

        # Changing field 'Fires2ExtingCosts.exting_costs'
        db.alter_column(u'fires_fires2extingcosts', 'exting_costs_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fires.ExtingCosts']))

        # Changing field 'Fires2ExtingCosts.sum'
        db.alter_column(u'fires_fires2extingcosts', 'sum', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))
        # Deleting field 'Fires2FireDamage.old_id'
        db.delete_column(u'fires_fires2firedamage', 'old_id')
