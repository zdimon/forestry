...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'forestry_valueparampolygon', 'value', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'ValueParamPolygon.value'
        db.alter_column(u'forestry_valueparampolygon', 'value', self.gf('django.db.models.fields.CharField')(default='0', max_length=250))
