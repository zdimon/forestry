...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TypeParamPolygon.value'
        db.alter_column(u'forestry_typeparampolygon', 'value', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'forestry.typeparampolygon': {
            ...
            'value': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
