...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ForestElement2GeoPolygon.diameter'
        db.alter_column(u'forestry_forestelement2geopolygon', 'diameter', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'ForestElement2GeoPolygon.geo_polygon'
        db.alter_column(u'forestry_forestelement2geopolygon', 'geo_polygon_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forestry.GeoPolygon'], null=True))

        # Changing field 'ForestElement2GeoPolygon.age'
        db.alter_column(u'forestry_forestelement2geopolygon', 'age', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ForestElement2GeoPolygon.percent'
        db.alter_column(u'forestry_forestelement2geopolygon', 'percent', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ForestElement2GeoPolygon.height'
        db.alter_column(u'forestry_forestelement2geopolygon', 'height', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'ForestElement2GeoPolygon.forest_element'
        db.alter_column(u'forestry_forestelement2geopolygon', 'forest_element_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forestry.ForestElement'], null=True))

    def backwards(self, orm):

        # Changing field 'ForestElement2GeoPolygon.diameter'
        db.alter_column(u'forestry_forestelement2geopolygon', 'diameter', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'ForestElement2GeoPolygon.geo_polygon'
        db.alter_column(u'forestry_forestelement2geopolygon', 'geo_polygon_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forestry.GeoPolygon']))

        # Changing field 'ForestElement2GeoPolygon.age'
        db.alter_column(u'forestry_forestelement2geopolygon', 'age', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ForestElement2GeoPolygon.percent'
        db.alter_column(u'forestry_forestelement2geopolygon', 'percent', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ForestElement2GeoPolygon.height'
        db.alter_column(u'forestry_forestelement2geopolygon', 'height', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'ForestElement2GeoPolygon.forest_element'
        db.alter_column(u'forestry_forestelement2geopolygon', 'forest_element_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forestry.ForestElement']))
