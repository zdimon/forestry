...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Fires.square'
        db.alter_column(u'fires_fires', 'square', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'Fires.date_begin'
        db.alter_column(u'fires_fires', 'date_begin', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Fires.fire_cause'
        db.alter_column(u'fires_fires', 'fire_cause_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fires.FireCause'], null=True))

        # Changing field 'Fires.crowning_square'
        db.alter_column(u'fires_fires', 'crowning_square', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'Fires.date_month'
        db.alter_column(u'fires_fires', 'date_month', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Fires.date_end'
        db.alter_column(u'fires_fires', 'date_end', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Fires.unforest_square'
        db.alter_column(u'fires_fires', 'unforest_square', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'Fires.exting_end'
        db.alter_column(u'fires_fires', 'exting_end', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Fires.ground_square'
        db.alter_column(u'fires_fires', 'ground_square', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'Fires.fire_detection'
        db.alter_column(u'fires_fires', 'fire_detection_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fires.FireDetection'], null=True))

        # Changing field 'Fires.exting_begin'
        db.alter_column(u'fires_fires', 'exting_begin', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Fires.square'
        db.alter_column(u'fires_fires', 'square', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'Fires.date_begin'
        db.alter_column(u'fires_fires', 'date_begin', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Fires.fire_cause'
        db.alter_column(u'fires_fires', 'fire_cause_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fires.FireCause']))

        # Changing field 'Fires.crowning_square'
        db.alter_column(u'fires_fires', 'crowning_square', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'Fires.date_month'
        db.alter_column(u'fires_fires', 'date_month', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Fires.date_end'
        db.alter_column(u'fires_fires', 'date_end', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Fires.unforest_square'
        db.alter_column(u'fires_fires', 'unforest_square', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'Fires.exting_end'
        db.alter_column(u'fires_fires', 'exting_end', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Fires.ground_square'
        db.alter_column(u'fires_fires', 'ground_square', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'Fires.fire_detection'
        db.alter_column(u'fires_fires', 'fire_detection_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fires.FireDetection']))

        # Changing field 'Fires.exting_begin'
        db.alter_column(u'fires_fires', 'exting_begin', self.gf('django.db.models.fields.DateTimeField')())
