...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FireDetection'
        db.delete_table(u'fires_firedetection')

        # Deleting model 'FireCause'
        db.delete_table(u'fires_firecause')

        # Deleting model 'ExtingCosts'
        db.delete_table(u'fires_extingcosts')

        # Deleting model 'FireDamage'
        db.delete_table(u'fires_firedamage')

        # Deleting model 'FireWorked'
        db.delete_table(u'fires_fireworked')

        # Deleting model 'Fires'
        db.delete_table(u'fires_fires')

        # Deleting model 'Fires2ExtingCosts'
        db.delete_table(u'fires_fires2extingcosts')

        # Deleting model 'Fires2FireDamage'
        db.delete_table(u'fires_fires2firedamage')

        # Deleting model 'Fires2FireWorked'
        db.delete_table(u'fires_fires2fireworked')

        # Deleting model 'Fires2GeoPolygon'
        db.delete_table(u'fires_fires2geopolygon')

        # Deleting model 'Meteocondition'
        db.delete_table(u'fires_meteocondition')
