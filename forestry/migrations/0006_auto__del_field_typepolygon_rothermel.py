...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TypePolygon.rothermel'
        db.delete_column(u'forestry_typepolygon', 'rothermel_id')


    def backwards(self, orm):
        # Adding field 'TypePolygon.rothermel'
        db.add_column(u'forestry_typepolygon', 'rothermel',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=False, to=orm['fires.Rothermel'], blank=True),
                      keep_default=False)
