...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fires.forestry_group'
        db.add_column(u'fires_fires', 'forestry_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['forestry.ForestryGroup'], db_column='forestry_group_id'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fires.forestry_group'
        db.delete_column(u'fires_fires', 'forestry_group_id')
    ...
    models = {
        ...
        u'fires.fires': {
            ...
            'forestry_group': ('django.db.models.fields.related.ForeignKey', [], {'default': 'False', 'to': u"orm['forestry.ForestryGroup']", 'null': 'True', 'db_column': "'forestry_group_id'", 'blank': 'True'}),
