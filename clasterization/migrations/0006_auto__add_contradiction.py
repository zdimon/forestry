...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Contradiction'
        db.create_table(u'clasterization_contradiction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ground_square_gen', self.gf('django.db.models.fields.CharField')(default='zero', max_length=10)),
            ('crowning_square_gen', self.gf('django.db.models.fields.CharField')(default='zero', max_length=10)),
            ('unforest_square_gen', self.gf('django.db.models.fields.CharField')(default='zero', max_length=10)),
            ('wood_volume_per_ha_gen', self.gf('django.db.models.fields.CharField')(default='zero', max_length=10)),
            ('pjc_gen', self.gf('django.db.models.fields.CharField')(default='zero', max_length=10)),
            ('pr_gen', self.gf('django.db.models.fields.CharField')(default='zero', max_length=10)),
            ('assessment_gen', self.gf('django.db.models.fields.CharField')(default='zero', max_length=10)),
        ))
        db.send_create_signal(u'clasterization', ['Contradiction'])


    def backwards(self, orm):
        # Deleting model 'Contradiction'
        db.delete_table(u'clasterization_contradiction')


    models = {
        u'clasterization.contradiction': {
            'Meta': {'object_name': 'Contradiction'},
