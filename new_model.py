...
class ArticleTranslation(models.Model):
    id = models.ForeignKey(Article, db_column='id')
...
class PageTranslation(models.Model):
    id = models.ForeignKey(Page, db_column='id')
    content = models.TextField(blank=True)
...
class ParamValueSelectTranslation(models.Model):
    id = models.ForeignKey(ParamValueSelect, db_column='id')
    name = models.CharField(max_length=250, blank=True)
    lang = models.CharField(max_length=2)
    class Meta:
        managed = False
...
class ProfileTranslation(models.Model):
    id = models.ForeignKey(Profile, db_column='id')
...
class ProjectsTranslation(models.Model):
    id = models.ForeignKey(Projects, db_column='id')
...
class TranslateTranslation(models.Model):
    id = models.ForeignKey(Translate, db_column='id')
...
class ValueParamPolygonTranslation(models.Model):
    id = models.ForeignKey(ValueParamPolygon, db_column='id')
    lang = models.CharField(max_length=2)
    class Meta:
        managed = False
