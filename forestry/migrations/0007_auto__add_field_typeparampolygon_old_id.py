...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TypeParamPolygon.old_id'
        db.add_column(u'forestry_typeparampolygon', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TypeParamPolygon.old_id'
        db.delete_column(u'forestry_typeparampolygon', 'old_id')
